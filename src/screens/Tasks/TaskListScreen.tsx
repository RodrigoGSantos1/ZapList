...
export function TaskListScreen() {
  const { tasks, loading, deleteTask, toggleTaskComplete, getTasksByFilter } = useTasks();
  ...
  if (loading) {
    return (
      <ThemedView variant="primary" className="flex-1 items-center justify-center">
    ...
    <ThemedView variant="primary" className="flex-1">
      <View className="p-4">
        ...
        {filteredTasks.length === 0 ? (
          <ThemedView variant="secondary" className="items-center rounded-lg p-8">
